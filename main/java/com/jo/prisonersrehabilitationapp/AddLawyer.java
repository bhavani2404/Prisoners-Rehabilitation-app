...
public class AddLawyer extends AppCompatActivity {
    EditText e2,e3,e10;
    RadioGroup ra;
    Button bb;
    TextView e11;
        ...
        bb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        ...
                        ||dpwd.equals(""))
                {
                    ...
                    if (checkedId == -1) {
                        Toast.makeText(AddLawyer.this, "Select gender please", Toast.LENGTH_SHORT).show();
                    } else {
    ...
    public class registeration extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AddLawyer.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String txt = "";
            try {
                String ur="http://"+ServerConnect.serverip+"/Android/prisonersrehabilitation/addlawyer.php?username="+ URLEncoder.encode(demail)
