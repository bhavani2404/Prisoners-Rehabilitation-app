...
public class AddPrisoner extends AppCompatActivity {
        ...
        bb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(demail.equals("")||dpwd.equals(""))
                {
                    ...
                    if (checkedId == -1) {
                        Toast.makeText(AddPrisoner.this, "Select gender please", Toast.LENGTH_SHORT).show();
                    } else {
    ...
    public class registeration extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AddPrisoner.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String txt = "";
            try {
                String ur="http://"+ServerConnect.serverip+"/Android/prisonersrehabilitation/addprisoner.php?username="+ URLEncoder.encode(demail)
