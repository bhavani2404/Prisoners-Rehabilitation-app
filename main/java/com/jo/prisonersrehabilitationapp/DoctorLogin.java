...
public class DoctorLogin extends AppCompatActivity {
    ...
    public class dlogin extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DoctorLogin.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String txt = "";
            try {
                String ur = "http://"+ServerConnect.serverip +"/Android/prisonersrehabilitation/doctorlogin.php?eusername="+eusername
                        +"&epassword="+epassword;
                Log.i("URL", ur);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if (file_url.trim().equals("Success")) {
                ...
                Intent in = new Intent(getApplicationContext(), ViewDoctorQuery.class);
