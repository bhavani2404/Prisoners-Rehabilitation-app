...
public class DoctorQuerySolution extends AppCompatActivity {
    Button dl;
    static EditText dlt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_query_solution);
    ...
    public class dlogin extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DoctorQuerySolution.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String txt = "";
            try {
                String ur = "http://"+ServerConnect.serverip +"/Android/prisonersrehabilitation/doctorpostsolution.php?eusername="+eusername+"&id="+ptax
                        ;
                Log.i("URL", ur);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if (file_url.trim().equals("Success")) {
                ...
                Intent in = new Intent(DoctorQuerySolution.this, HomePage.class);
