...
public class LawyerConsult extends AppCompatActivity {
    Button dl;
    static EditText dlt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView=findViewById(R.id.law);
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),ViewSolution.class);
    ...
    public class dlogin extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(LawyerConsult.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String txt = "";
            try {
                String ur = "http://"+ServerConnect.serverip +"/Android/prisonersrehabilitation/lawyerpostquery.php?eusername="+eusername+
        ...
        protected void onPostExecute(String file_url) {
            ...
            if (file_url.trim().equals("Success")) {
                ...
                Intent in = new Intent(LawyerConsult.this, PrisonerHome.class);
                startActivity(in);
