...
public class LawyerLogin extends AppCompatActivity {
    ...
    public class dlogin extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(LawyerLogin.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String txt = "";
            try {
                String ur = "http://"+ServerConnect.serverip +"/Android/prisonersrehabilitation/lawyerlogin.php?eusername="+eusername
                        +"&epassword="+epassword;
                Log.i("URL", ur);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if (file_url.trim().equals("Success")) {
                ...
                Intent in = new Intent(getApplicationContext(), ViewLawyerQuery.class);
