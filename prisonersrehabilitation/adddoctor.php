...
if($connect)
{
				...
				$sqlCheckUname = mysql_query("SELECT * FROM  doctor WHERE username LIKE '$username'");
				...
				else
				{
					...
					$sql_register = mysql_query("INSERT INTO doctor VALUES ('','$username','$econtact','$gender','$epassword')");
